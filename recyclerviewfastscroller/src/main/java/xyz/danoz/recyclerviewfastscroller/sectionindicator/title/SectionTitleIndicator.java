...
public abstract class SectionTitleIndicator<T> extends AbsSectionIndicator<T> {
	 ...
	 *
	 * @param color
	 * 		provided in XML via the {@link R.styleable#SectionTitleIndicator_rfs_backgroundColor} parameter. If not
	 ...
	 *
	 * @param color
	 * 		to set as the indicator's background color
	 */
	 ...
	 *
	 * @param color
	 * 		provided in XML via the {@link R.styleable#SectionTitleIndicator_rfs_textColor} parameter. If not
	 ...
	 *
	 * @param color
	 * 		to set as the indicator's text color
	 */
	 ...
	 *
	 * @param text
	 * 		to display in the section title popup
	 */
